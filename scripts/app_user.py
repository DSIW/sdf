...
def import_data():
    ...
    auth_user_3.username = 'maria'
    auth_user_3.first_name = 'Maria'
    auth_user_3.last_name = 'Mustermann'
    auth_user_3.email = 'maria@mustermann.de'
    auth_user_3.emailConfirm = True
    auth_user_3.paypal = 'maria@mustermann.de'
    auth_user_3.location = 'Köln'
